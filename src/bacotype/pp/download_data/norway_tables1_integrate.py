...
Usage
─────
    uv run python src/bacotype/pp/download_data/norway_tables1_integrate.py
...
from bacotype.pp.download_data.norway_cohort_audit import (
    DEFAULT_METADATA,
    UMBRELLA_PROJECT,
    _gca_primaries,
...
EUTILS_TOOL = "bacotype-norway-tables1"
