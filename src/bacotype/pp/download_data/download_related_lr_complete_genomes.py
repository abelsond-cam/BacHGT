...
Usage
─────
    uv run python src/bacotype/pp/download_data/download_related_lr_complete_genomes.py
...
from bacotype.pp.download_data.norway_cohort_audit import ncbi_headers
