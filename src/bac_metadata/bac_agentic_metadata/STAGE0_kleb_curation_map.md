...
| Compute `paper_coverage_for_taxon` for the chosen paper | **Mixed** — denominator deterministic (EBI taxon-of-interest count); numerator (how much the paper describes) is judgement |
