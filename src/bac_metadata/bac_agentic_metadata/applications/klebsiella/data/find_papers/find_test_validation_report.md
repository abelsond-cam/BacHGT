...
## Find-accuracy: 0.67  (31/46 matched among accessions with a curated link)

Category counts: {'exact_match': 23, 'not_found': 8, 'title_match': 8, 'mismatch': 7, 'no_curated_link': 1}
...
Confidence mix: {'high': 30, 'medium': 11, 'low': 6}
...
- `PRJEB32655` found=10.1099/mgen.0.001035 (via published_version,web_search, verified=False) vs 1 curated: ['https://www.ncbi.nlm.nih.gov/bioproject/?term=PRJEB32655']
...
- `PRJNA810752` (n_candidates=1) curated=['Could not find']
- `PRJNA339843` (n_candidates=9) curated=['https://journals.asm.org/doi/epub/10.1128/aac.01127-24']
- `PRJEB43870` (n_candidates=2) curated=['https://doi.org/10.3389/fmicb.2023.1193274']
- `PRJNA433394` (n_candidates=6) curated=['https://journals.asm.org/doi/10.1128/aac.01127-24']
