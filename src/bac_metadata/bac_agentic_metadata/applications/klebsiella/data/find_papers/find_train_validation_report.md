...
## Find-accuracy: 0.68  (69/102 matched among accessions with a curated link)

Category counts: {'exact_match': 57, 'mismatch': 26, 'title_match': 12, 'not_found': 7, 'no_curated_link': 7}
...
## Grounded-verify: 68/109 picks had the accession confirmed in the paper text.
Confidence mix: {'high': 69, 'medium': 34, 'low': 6}
...
- `PRJDB5929` found=10.1128/jcm.01080-22 (via web_search, verified=False) vs 1 curated: ['https://pmc.ncbi.nlm.nih.gov/articles/PMC9453063/']
- `PRJNA845975` found=10.1101/2025.06.11.25329357 (via web_search, verified=True) vs 1 curated: ['https://www.medrxiv.org/content/10.1101/2025.06.11.25329357v1.full']
...
- `PRJEB42462` (n_candidates=7) curated=['https://www.medrxiv.org/content/10.1101/2025.06.28.25330253v1.full.pdf', 'https://www.medrxiv.org/content/10.1101/2025.06.28.25330253v1.full; https://pathogen.watch/collection/klebnet-neonatal-sepsis']
...
- `PRJEB22890` (n_candidates=1) curated=['https://pubmed.ncbi.nlm.nih.gov/33188415/']
- `PRJEB20799` (n_candidates=1) curated=['https://pathogen.watch/collection/klebnet-neonatal-sepsis']
- `PRJNA398288` (n_candidates=5) curated=['https://academic.oup.com/jac/article/73/3/634/4745835#supplementary-data']
