...
- Excluding the out-of-scope `Refseq_collection`, the agent's completeness minus manual is host +6.2, country +2.8, collection_date +6.6, isolation_source +3.3 percentage points.
- Pooled over all 87,293 samples (incl. Refseq): host +2.5, country -1.2, collection_date +2.6, isolation_source +0.0.
...
| split | n | raw ENA % | manual gold % | agent % | agent − manual |
|---|--:|--:|--:|--:|--:|
| train | 19,978 | 43.6 | 71.6 | 67.0 | -4.6 |
...
| TOTAL | 87,293 | 52.5 | 69.0 | 69.0 | +0.0 |
| TOTAL_excl_Refseq | 83,780 | 54.7 | 68.6 | 71.9 | +3.3 |
