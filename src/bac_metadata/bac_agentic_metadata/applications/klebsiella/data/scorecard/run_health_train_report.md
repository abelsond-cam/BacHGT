...
## ⚠️ **19 ACTIONABLE + 7 BLOCKED outstanding — supplement & rerun**

436 (study × field) cells over 109 fold studies — **FILLED 378 · ACTIONABLE 19 · BLOCKED 7 · EXHAUSTED 32**. ALL CLEAR requires ACTIONABLE and BLOCKED both 0 (every cell FILLED, or EXHAUSTED with a logged reason / curator acceptance).

## Actionable worklist — do these, then rerun

### Fetch supplementary tables (11)
...
7 studies have a supplementary table with the fields but no joinable accession key (anchoring): PRJEB1563, PRJEB36486, PRJEB38289, PRJNA1087366, PRJNA604910, PRJNA767944, PRJNA804332

## Escalation status
- queue generated: 41 rows; answered: 27; applied fills: 10770.
...
|---|---|---|---|---|---|---|---|
| country | 0.9334 | 0.8821 | 0.1203 | 0.1145 | 0.0782 | 0.0 |  |
| collection_date | 0.8665 | 0.7473 | 0.0541 | 0.1553 | 0.1063 | 0.0 |  |
| isolation_source | 0.7292 | 0.6689 | 0.0628 | 0.1391 | 0.0824 | 0.0 |  |
| host | 0.8703 | 0.7891 | 0.3753 | 0.004 | 0.0472 | 0.0 |  |
