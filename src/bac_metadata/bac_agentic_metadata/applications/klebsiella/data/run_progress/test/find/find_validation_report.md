...
## Find-accuracy: 0.54  (25/46 matched among accessions with a curated link)

Category counts: {'exact_match': 19, 'not_found': 16, 'title_match': 6, 'mismatch': 5, 'no_curated_link': 1}
...
Confidence mix: {'high': 27, 'low': 13, 'medium': 7}
...
- `PRJEB29739` (n_candidates=10) curated=['https://pmc.ncbi.nlm.nih.gov/articles/PMC8634535/; https://pathogen.watch/collection/klebnet-neonatal-sepsis']
- `PRJEB29424` (n_candidates=1) curated=['https://www.thelancet.com/pdfs/journals/lanmic/PIIS2666-5247(22)00181-1.pdf']
- `PRJEB53835` (n_candidates=0) curated=['-']
- `PRJEB32655` (n_candidates=0) curated=['https://www.ncbi.nlm.nih.gov/bioproject/?term=PRJEB32655']
- `PRJNA810752` (n_candidates=0) curated=['Could not find']
- `PRJNA339843` (n_candidates=6) curated=['https://journals.asm.org/doi/epub/10.1128/aac.01127-24']
- `PRJEB43870` (n_candidates=1) curated=['https://doi.org/10.3389/fmicb.2023.1193274']
- `PRJNA532291` (n_candidates=1) curated=['Could not find']
- `PRJNA433394` (n_candidates=5) curated=['https://journals.asm.org/doi/10.1128/aac.01127-24']
- `PRJNA594602` (n_candidates=0) curated=['https://enviromicro-journals.onlinelibrary.wiley.com/doi/full/10.1111/1462-2920.15721']
- `PRJNA547865` (n_candidates=0) curated=['https://pubmed.ncbi.nlm.nih.gov/31504571/']
- `PRJNA922900` (n_candidates=0) curated=['https://doi.org/10.3389/fmicb.2023.1193274']
- `PRJEB57159` (n_candidates=0) curated=['https://doi.org/10.3389/fmicb.2023.1193274']
- `PRJNA514908` (n_candidates=0) curated=['https://academic.oup.com/jac/article/74/10/2895/5538005#google_vignette']
