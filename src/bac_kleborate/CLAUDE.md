...
| `bac_panaroo.annotate_nodes.annotate_panaroo_nodes_minimap` | minimap2's Panaroo-cluster representatives against the vendored references — labels Panaroo nodes with virulence / AMR hits |
